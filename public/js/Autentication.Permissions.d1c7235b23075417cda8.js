...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: _objectSpread(_objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])({
    ...
    listenPermissionUpdateButton: function listenPermissionUpdateButton() {
      var self = this;
      $(document).on('click', '.btn-permissions-update', function () {
        var permissionId = $(this).data('id');
        var permission = self.filterArrayDataForId(self.permissions, permissionId);
        self.openPermissionForm(true, permission);
      });
    },
    listenPermissionDeleteButton: function listenPermissionDeleteButton() {
      var self = this;
