...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    openPermissionsForm: function openPermissionsForm(newVal) {
      if (newVal) {
  ...
  methods: _objectSpread(_objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapMutations"])({
    ...
    submitPermissionForm: function submitPermissionForm() {
      var _this = this;

      axios.post('/permissions', this.permission).then(function (response) {
        _this.addPermissionToList(response.data);

        Swal.fire({
          title: 'El permiso se registro correctamente.',
          icon: 'success'
        }).then(function () {
          return _this.modalHidden();
        });
                      ...
                      _c(
                        ...
                        _vm._l(_vm.permissions, function(permission) {
                          return _c("tr", { key: permission.id }, [
                            _c("td", {
                              domProps: { textContent: _vm._s(permission.id) }
                            }),
                            _vm._v(" "),
                            _c("td", {
                              domProps: { textContent: _vm._s(permission.name) }
                            }),
                            _vm._v(" "),
                            _c("td", {
                              domProps: {
                                textContent: _vm._s(permission.description)
                              }
                            }),
                            _vm._v(" "),
                            _c("td", {
                              domProps: {
                                textContent: _vm._s(permission.created_at)
                              }
                            })
                          ])
                        }),
